...
// The function should take two parameters(playerSelection, computerSelection) {
    ...
    // - make the two parameters lowercase
    // - return a string that declares the winner of the round
    // - there can only be 4 possible outcomes:
    // - 1. "You Lose! Paper beats Rock"
    // - 2. "You Lose! Scissors beats Paper"
    // - 3. "You Lose! Rock beats Scissors"
    // - 4. "It's a tie! You selected the same item."
    // - "You Lose!" will be replaced by "You Won!" if the playerSelection is the winner;
// }
